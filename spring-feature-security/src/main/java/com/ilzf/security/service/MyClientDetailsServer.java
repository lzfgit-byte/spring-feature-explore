...
import com.ilzf.security.entity.MyClientDetailEntity;
...
public class MyClientDetailsServer extends InMemoryClientDetailsService {
    ...
    public void loadClientDetails() {
        ...
        store.put("client", new MyClientDetailEntity("client", SecurityInfo.RESOURCE_ID, "app", "all"));
        store.put("client2", new MyClientDetailEntity("client2", SecurityInfo.RESOURCE_ID, "app", "all"));
        store.put("client3", new MyClientDetailEntity("client3", SecurityInfo.RESOURCE_ID, "app", "all"));
